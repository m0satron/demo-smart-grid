...
import energyFast from '@/assets/energyAgentFast.json'
import energyMedium from '@/assets/energyAgentMedium.json'
import energySlow from '@/assets/energyAgentSlow.json'
